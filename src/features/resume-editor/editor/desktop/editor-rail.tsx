            ...
            <TooltipTrigger
              render={
                <button
                  ...
                  className={cn(
                    "flex size-10 cursor-pointer flex-col items-center justify-center rounded-md outline-none transition-[color,box-shadow,transform] active:translate-y-px",
                    FOCUS_RING_CLASS,
                    "text-muted-foreground aria-[pressed=false]:hover:bg-muted/60 aria-[pressed=false]:hover:text-foreground",
