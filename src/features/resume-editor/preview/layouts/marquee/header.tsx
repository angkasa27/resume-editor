...
/** One dark full-bleed band: name and role sharing the top line, the contact
 * strip under them, and the photo — when there is one — ranged right against
 * the band's own padding. */
export function MarqueeHeader({ context }: LayoutHeaderProps) {
  const { draft } = context;

  return (
    <header className={`${styles.header} layout-header`} data-layout="marquee">
      <div className="marquee-band">
        <div className="marquee-identity">
