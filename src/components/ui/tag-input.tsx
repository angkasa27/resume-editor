      ...
      {value.map((tag, index) => (
        ...
        >
          ...
          <button
            ...
            className="grid size-3.5 place-items-center rounded-full text-muted-foreground transition-[color,box-shadow] hover:bg-muted hover:text-foreground outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/40"
            onClick={(event) => {
