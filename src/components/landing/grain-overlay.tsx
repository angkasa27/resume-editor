/**
 * Fixed overlay, above background and below content — adds subtle tooth so flat
 * sections don't read as empty. Pure CSS: an inline SVG fractal-noise data URI
 * tiled at low opacity, no JS and negligible cost.
 */
